...
?>
      <div id="user<?php echo $user_id; ?>" class="row_over<?php echo $class; ?>">
        <table>
          <tbody>
            <tr>
              <td width="5%"><button class="btn_save" onClick="EditUserJQ('<?php echo $user_id; ?>')"><?=$laguages[$default_lang]['btn_save'];?></button></td>
              ...
              <td width="9%"><button class="access_rights button" button-id="<?php echo $user_id; ?>">Access rights</button></td>
              <td width="5%">
...
<!--  <div class="add_new_form">
    ...
    <table>
      <tbody>
        <tr class="row_over">
          <td width="5%"><button class="btn_save" onClick="AddUser('1')" title="Update"><?=$laguages[$default_lang]['btn_save'];?></button></td>
...
<!--  <div class="search_form">
    ...
    <table>
      <tbody>
        <tr class="row_over">
          <td width="5%"><button class="button btn_save" onClick="SearchUsers('3')"><?php echo BTN_SEARCH; ?></button></td>
