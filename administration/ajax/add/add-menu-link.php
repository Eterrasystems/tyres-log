<?php
  ...
  if(!empty($menu_name) && !empty($menu_url)) {
    ...
    $query = "INSERT INTO `menus`(`menu_id`, `menu_parent_id`, `menu_level`, `menu_has_children`, `menu_path_name`, `menu_name`, `menu_url`, `menu_friendly_url`, `menu_image_url`, `menu_sort`, `menu_active`) 
                          VALUES ('','$menu_parent_id','$menu_parent_level','$menu_has_children','$menu_path_name','$menu_name','$menu_url',$menu_friendly_url,$menu_image_url,'$menu_sort','$menu_active')";
    //echo $query;exit;
