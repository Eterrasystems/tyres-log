  ...
  <table>
    <thead>
      <tr>
        ...
        <td width="10%"><?php echo PASSWORD; ?></td>
        <td width="10%"><?php echo FIRSTNAME; ?></td>
        <td width="10%"><?php echo LASTNAME; ?></td>
        <td width="10%"><?php echo ASSIGNED_ТО_WAREHOUSE; ?></td>
        <td width="10%"><?php echo USER_RIGHTS; ?></td>
        <td width="5%"><?php echo USER_IS_ACTIVE; ?></td>
        <td width="5%"><?php echo USER_LOG; ?></td>
        <td width="5%"><?php echo IP_IN_USE; ?></td>
        <td width="5%"><?php echo IP; ?></td>
...
<?php
  ...
  // we gonna select only `users`.`user_type_id` = 2 - regular user
...
?>
      <div id="user<?php echo $user_id; ?>" class="row_over<?php echo $class; ?>">
        ...
        <div class="users details<?php echo $user_id; ?>">
  ...
  $(document).ready(function() {
    $(".access_rights").click(function() {
      ...
      if($(".details"+user_id).hasClass("access_rights_edit")) {
        $(".users").removeClass("access_rights_edit");
      } else {
        $(".users").removeClass("access_rights_edit");
