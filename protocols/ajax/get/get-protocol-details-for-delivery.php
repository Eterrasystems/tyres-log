<?php
  ...
  $query_warehouses_tyres = "SELECT `tyres_storages`.`vehicle_model_id`, `tyres_storages`.`client_id`, `tyres_storages`.`tyre_note`, 
                                    `tyres_storages`.`vehicle_plate`, `vehicles_makes`.`vehicle_make_id`, 
...
<!--client_name-->
  <div class="form_row ">
    ...
    <input type="text" name="client_name" id="client_name" class="input_text" style="margin-right:10px;" value="<?php echo "$protocol_client_firstname $protocol_client_lastname"; ?>" disabled="disabled">
  </div>
...
<!--vehicle_make-->
  <div class="form_row">
    ...
    <select id="vehicle_make" onChange="LoadVehicleModelsForMakeInSelect()" disabled="disabled">
...
<!--vehicle_model-->
  <div class="form_row">
    ...
    <select id="vehicle_model_default" style="display: none;" disabled="disabled">
      <option value="0" selected="selected"><?=$laguages[$default_lang]['choose_vehicle_make_first'];?></option>
    </select>
    <select id="vehicle_model" disabled="disabled">
<?php
...
<!--vehicle_plate-->
  <div class="form_row">
    ...
    <input type="text" name="vehicle_plate" id="vehicle_plate" class="input_text" value='<?php echo $protocol_vehicle_plate; ?>' disabled="disabled">
...
?>
    <fieldset id="tyres_form_<?php echo $tyre_position_code;?>" tyre-storage-details-id="<?php echo $tyre_storage_details_id;?>" tyre-position-id="<?php echo $tyre_position_id;?>" class="<?php echo $tyre_position_css_class;?> tyre_form active" style="width: <?php echo $style_width;?>;" disabled="disabled">
