...
?>
  <div class="tyre_storage protocols_row row_over_<?=$tyre_storage_id;?><?="$class $div_class";?>" <?=$tr_visibility;?>>
    <table>
      <tbody>
        <tr>
  ...
  <div class="tyre_storage details_<?=$tyre_storage_id; ?>" style="display: none;">
<?php
  $query_storage_details = "SELECT `tyres_storages_details`.`tyre_dot`,`tyres_storages_details`.`tyre_grapple_depth`,`tyres_storages_details`.`tyre_defects`, 
                                    ...
                                    `tyres_makes`.`tyre_make`,`tyres_models`.`tyre_model`,`tyres_seasons`.`tyre_season`,`tyres_width`.`tyre_width`,
...
?>
    <div class="printable_area_01_<?=$tyre_storage_id; ?>" style="display: none;">
