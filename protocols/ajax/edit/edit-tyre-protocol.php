<?php
  ...
  if(isset($_POST['tyre_storage_details_ids'])) {
    $tyre_storage_details_ids = $_POST['tyre_storage_details_ids'];
  }
  ...
  if(!empty($user_id) && isset($_POST['tyre_storage_details_ids']) && !empty($tyre_storage_details_ids)) {
    
    mysqli_query($db_link, "START TRANSACTION");
    
    $query = "UPDATE `tyres_storages` SET `client_id`='$client_id',
                                          `warehouse_id`='$warehouse_id',
                                          `vehicle_model_id`='$vehicle_model_id',
                                          `vehicle_plate`='$vehicle_plate',
                                          `tyre_note`=$tyre_note,
                                          `tyre_storage_date`='$tyre_storage_date' 
                                    WHERE `tyre_storage_id`='$tyre_storage_id'";
    $all_queries = $query."\n";
    //echo $query;exit;
    ...
    foreach($tyre_storage_details_ids as $key => $tyre_storage_details_id) {
      
      $tyre_position_id = $tyre_position_ids[$key];
      ...
      $query = "UPDATE `tyres_storages_details` SET `tyre_model_id`='$tyre_model_id', 
                                                    `tyre_season_id`='$tyre_season_id', 
                                                    ...
                                                    `tyre_dot`='$tyre_dot', 
                                                    `tyre_grapple_depth`='$tyre_grapple_depth', 
                                                    `tyre_defects`=$tyre_defects_text
                                    WHERE `tyre_storage_details_id`='$tyre_storage_details_id'";
      $all_queries .= $query."\n";
      //echo $query;exit;
      $result = mysqli_query($db_link, $query);
      if(!$result) {
    ...
    echo $laguages[$default_lang]['protocol_updated_successfully'];
